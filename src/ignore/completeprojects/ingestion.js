/**
 * completedprojects/ingestion.js
 * Initialize the `completedprojects` collection in MongoDB.
...
initializeDatabase('completeprojects', 'completeprojects.csv').catch((err) => {
  console.error(err);
});
